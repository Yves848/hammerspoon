...
obj.groups = {
  ...
  { title = "Neovim (LazyVim)",
    subtitle = "leader = Espace · adapté AZERTY : ( ) remplacent [ ] pour la navigation",
    sections = {
      { title = "Fenêtres (splits)", accent = "#cba6f7", items = {
        ...
        { "Espace w v", "Split vertical (droite) — remplace Espace |" },
        { "Espace w d", "Fermer la fenêtre" },
        { "Espace w m", "Zoom (agrandir / restaurer)" },
        { "Espace u z", "Mode Zen" },
      } },
      { title = "Nav. par sauts — ( ) = [ ]", accent = "#f38ba8", items = {
        { "( )",     "Préfixes AZERTY : ( = [ , ) = ] (crochets aussi OK)" },
        { "( d / ) d", "Diagnostic précédent / suivant" },
        { "( e / ) e", "Erreur précédente / suivante" },
        { "( q / ) q", "Entrée quickfix préc. / suiv." },
        { "( h / ) h", "Hunk git précédent / suivant" },
        { "( t / ) t", "Todo-comment préc. / suiv." },
      } },
      { title = "Buffers", accent = "#89b4fa", items = {
        { "⇧ h / ⇧ l",  "Buffer précédent / suivant" },
        { "( b / ) b",  "Buffer précédent / suivant (= [b ]b)" },
      ...
      { title = "Onglets", accent = "#a6e3a1", items = {
        { "g t / g T",          "Onglet suivant / précédent (AZERTY-friendly)" },
